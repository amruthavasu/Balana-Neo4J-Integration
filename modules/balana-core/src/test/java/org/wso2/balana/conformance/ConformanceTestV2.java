...
public class ConformanceTestV2 extends TestCase {
	 ...
	 */
	private final static String VERSION_DIRECTORY = "suite1";
	...
	public void testConformanceTestA() throws Exception {
		...
		for (int i = 1; i < 14; i++) {
			...
			if (new File(file.getCanonicalPath() + File.separator + TestConstants.RESOURCE_PATH + File.separator
					...
					+ TestConstants.REQUEST_DIRECTORY + File.separator + "IIA" + policyNumber + "Request.xml")
							.exists()) {
	...
	public void testConformanceTestB() throws Exception {
		...
		for (int i = 1; i < 14; i++) {
			...
			if (new File(file.getCanonicalPath() + File.separator + TestConstants.RESOURCE_PATH + File.separator
					+ ROOT_DIRECTORY + File.separator + VERSION_DIRECTORY + File.separator
					+ TestConstants.REQUEST_DIRECTORY + File.separator + "IIB" + policyNumber + "Request.xml")
							.exists()) {
	...
	public void testConformanceTestC() throws Exception {
		...
		for (int i = 1; i < 14; i++) {
			...
			// 105 issue
			if (i == 3 || i == 12 || i == 14 || i == 23 || i == 54 || i == 55 || i == 88 || i == 89 || i == 92
					|| i == 93 || i == 98 || i == 99 || i == 105) {
			...
			if (new File(file.getCanonicalPath() + File.separator + TestConstants.RESOURCE_PATH + File.separator
					+ ROOT_DIRECTORY + File.separator + VERSION_DIRECTORY + File.separator
					+ TestConstants.REQUEST_DIRECTORY + File.separator + "IIC" + policyNumber + "Request.xml")
							.exists()) {
				...
				if (request != null) {
					...
					String policyId = file.getCanonicalPath() + File.separator + TestConstants.RESOURCE_PATH + File.separator
							+ ROOT_DIRECTORY + File.separator + VERSION_DIRECTORY + File.separator
							+ TestConstants.REQUEST_DIRECTORY + File.separator + "IID" + policyNumber + "Policy_2.xml";
	...
	public void testConformanceTestD() throws Exception {
		...
		for (int i = 1; i < 14; i++) {
			...
			if (new File(file.getCanonicalPath() + File.separator + TestConstants.RESOURCE_PATH + File.separator
					+ ROOT_DIRECTORY + File.separator + VERSION_DIRECTORY + File.separator
					+ TestConstants.REQUEST_DIRECTORY + File.separator + "IID" + policyNumber + "Request.xml")
							.exists()) {
